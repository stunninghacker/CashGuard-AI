...
> **Source of truth for current metrics:** `CURRENT_METRICS.md`. Honest leak-free ROC-AUC **0.6456**.
...
found and fixed (see `MODEL_CARD.md`); the honest forecast-safe **ROC-AUC is 0.6456**
(P@20/50/100/200/500/1000 = 0.70/0.70/0.67/0.57/0.434/0.329 · prf@0.7 = 32 alerts / P 0.75 /
