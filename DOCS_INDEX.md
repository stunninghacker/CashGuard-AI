...
- **docs/DEMO_CREDENTIALS.md** — synthetic demo logins (**NOT FOR PRODUCTION**) — click-by-click demo walkthrough + DEMO_MODE fallback plan
...
- **FINAL_KILL_TEST_AUDIT.md** — the final independent pass: permutation tests, generalization splits, report-scope fix — why the architecture cannot create a self-reinforcing policing loop
...
- **Q&A_PREPARATION.md** — 75 hostile questions answered (team prep)
