...
session, but its 24h-horizon ROC-AUC (0.9261 <sup>⚠ superseded → honest 0.6273</sup>) is consistent with the live
retrain (0.9272 <sup>⚠ superseded → honest 0.6273</sup>) and the live time-forward split (0.926 <sup>⚠ superseded → honest 0.6273</sup>) — the numbers are
...
|---|---|---|---|---|---|---|
| 2h | 0.921 <sup>⚠ superseded → honest 0.6273</sup> | 0.039 | 0.04 | 0.267 | 0.003 | **INSUFFICIENT → HOLD** |
| 6h | 0.917 | 0.076 | 0.082 | 0.280 | 0.006 | **INSUFFICIENT → HOLD** |
| 12h | 0.916 | 0.157 | 0.18 | 0.226 | 0.016 | **INSUFFICIENT → HOLD** |
| **24h** | **0.926 <sup>⚠ superseded → honest 0.6273</sup>** | **0.408** | 0.528 | 0.176 | 0.062 | MEDIUM |
