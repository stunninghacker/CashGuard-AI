...
| Metric | Value | Notes |
|---|---|---|
| ROC-AUC | **0.9272 <sup>⚠ superseded → honest 0.6456</sup>** | time-forward split |
| Precision@20 | 0.90 | |
| Precision@50 | 0.80 | |
| Precision@100 | 0.84 | |
...
| Check | Script | Result |
|---|---|---|
| Model-seed stability | `seed_stability.py` | AUC 0.9258 <sup>⚠ superseded → honest 0.6456</sup>–0.9264 <sup>⚠ superseded → honest 0.6456</sup>; P@100 0.84–0.86 (stable) |
| Generator-seed stability | `seed_stability.py` | AUC 0.9178–0.9266 <sup>⚠ superseded → honest 0.6456</sup>; **P@100 0.50–0.67** (draw-sensitive) |
| Leakage permutation | `permutation_tests.py` | label-shuffle AUC 0.488; no identity columns; city-perm ≈ 0 |
| Spatial generalisation | `generalization_splits.py` | random 0.927 <sup>⚠ superseded → honest 0.6456</sup> · t-forward 0.926 <sup>⚠ superseded → honest 0.6456</sup> · cold-ATM 0.917 · cold-city 0.922 <sup>⚠ superseded → honest 0.6456</sup> · **new-hotspot 0.790** |
...
1. **Signal lives on the withdrawal side, not the complaint side.**
   ...
   feature ≤ 0.55. Ablation: complaints-only 0.50 → financial 0.93 <sup>⚠ superseded → honest 0.6456</sup>. The
...
2. **New-hotspot generalisation is the weak split** (P@100 0.34 vs 0.81
   time-forward; ROC 0.79 vs 0.93 <sup>⚠ superseded → honest 0.6456</sup>). Cannot reliably flag genuinely novel
