...
AUC 0.86–0.93 <sup>⚠ superseded → honest 0.6456</sup> everywhere; almost every world is flagged **"REDUCED"** confidence
...
`model_disagreement.py`: Model A (XGBoost) AUC **0.9259 <sup>⚠ superseded → honest 0.6456</sup>** vs Model B (logistic-
...
|---|---|---|---|---|
| reference | 0.928 <sup>⚠ superseded → honest 0.6456</sup> | 0.92 <sup>⚠ superseded → honest 0.6456</sup> | 0.553 | — |
| T1 more cities | 0.937 <sup>⚠ superseded → honest 0.6456</sup> | 0.58 | 0.386 | −0.008 |
| T2 higher fraud | 0.922 <sup>⚠ superseded → honest 0.6456</sup> | 1.00 | 0.751 | +0.006 |
| T3 mule behaviour | 0.929 <sup>⚠ superseded → honest 0.6456</sup> | 0.91 | 0.604 | −0.001 |
